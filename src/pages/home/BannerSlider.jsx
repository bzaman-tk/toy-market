...
const BannerSlider = () => {
    return (
        <div className="carousel w-full sm:h-[600px] my-6">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute top-0 left-0 flex flex-col justify-center items-center h-full w-full rounded-2xl" style={{ backgroundColor: 'rgba(0,0,0,.8)' }}>
                    <h2 className="text-2xl w-8/12 sm:text-5xl  font-bold text-orange-600 mb-5 sm:mb-10 sm:w-1/2 text-center">
                        Best Dispecable Toys Ever
                    </h2>
                    <p className="mb-10 w-1/2 text-center hidden sm:block">
                    ...
                    <button className="btn btn-sm sm:btn border  text-orange-600 bg-white">See More</button>
                </div>
